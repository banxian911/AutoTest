...
public class CameraPreviewFrameLayout extends RelativeLayout {
    ...
    public CameraPreviewFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        Tuple<Integer, Integer> tuple = CameraUtil.getOptimalSize(
